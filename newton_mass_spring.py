...
solver = NewtonPCGSolver(data=sim_data, max_iterations=100)
...
recorder = FrameRecorder(output_dir="captures/newton_pcg", mode=RecordingMode.RUNNING_ONLY, make_video=True, fps=30)
